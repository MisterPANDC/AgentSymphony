defmodule SymphonyElixir.Persistence.ProjectSetting do
  ...
  @fields ~w(api_root project_ref project_id path_with_namespace name web_url visibility last_validated_at last_validation_error read_only automation_credential_mode encrypted_project_access_token project_access_token_set_by_identity_id project_access_token_set_at)a
