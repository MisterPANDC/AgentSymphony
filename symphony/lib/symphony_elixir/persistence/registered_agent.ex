defmodule SymphonyElixir.Persistence.RegisteredAgent do
  ...
  @asset_install_statuses ~w(pending installing configured failed)
  ...
  schema "registered_agents" do
    ...
    field(:asset_install_status, :string, default: "pending")
    field(:asset_install_started_at, :utc_datetime_usec)
    field(:asset_install_finished_at, :utc_datetime_usec)
    field(:asset_install_exit_status, :integer)
    field(:asset_install_message, :string)
    field(:skill_names, {:array, :string}, default: [])
    field(:plugin_names, {:array, :string}, default: [])
  ...
  @fields ~w(id provider name auth_mode codex_home credential_status login_started_at last_login_exit_status last_login_message mcp_install_status mcp_install_started_at mcp_install_finished_at mcp_install_exit_status mcp_install_message mcp_server_names asset_install_status asset_install_started_at asset_install_finished_at asset_install_exit_status asset_install_message skill_names plugin_names usage_status usage_snapshot usage_checked_at usage_error)a
  ...
  @spec asset_install_statuses() :: [String.t()]
  def asset_install_statuses, do: @asset_install_statuses
  ...
  def changeset(agent, attrs) do
    ...
    |> validate_inclusion(:asset_install_status, @asset_install_statuses)
